...
class Peg_Board_55:
    ...
    def reward(self,board):
        if self.pegs_left(board) == 1:
            rewards = 100000000
        # elif self.pegs_left(board) == 2:
        #     return 1000
        # elif self.pegs_left(board) == 3:
        #     return 100
        # elif self.pegs_left(board) == 4:
        #     return 10
        # # elif self.pegs_left(board) >= 8:
        # #     return 0
        ...
        #     rewards += rewards
            #rewards = -np.power(self.pegs_left(board),2)

            # for i in range(len(board)):
            #     for j in range(len(board[0])):
            #         if board[i, j] == 1:
            #             rewards -= np.sqrt(np.square(i - 3) + np.square(j - 3))
            # rewards -= np.power(np.count_nonzero(board==0),3)
        return rewards
