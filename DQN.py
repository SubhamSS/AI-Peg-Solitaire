...
from DQN_models import QNetwork
from DQN_CNN_Model import QNetworkCNN
import numpy as np
...
class DQN(object):
    def __init__(self, state_size, action_size):
        ...
        # self.qnetwork_local = QNetworkCNN(self.state_size, self.action_size)
        # self.qnetwork_target = QNetworkCNN(self.state_size, self.action_size)
